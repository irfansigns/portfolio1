            ...
            <div class="row">
              ...
              <div class="col-lg-3 order-2 order-lg-1">
                ...
                <ul class="list-unstyled small text-muted pl-lg-4 font-weight-normal">
                  ...
                  <li class="mb-2"><a class="reset-anchor" href={{ route('shop.cat',$categories->id) }}>{{$categories->cname}}</a></li>
                  @endforeach
                </ul>
                  ...
                  <div class="col-lg-4 col-sm-6">
                    <div class="product text-center">
                      <div class="mb-3 position-relative">
                        <div class="badge text-white badge-"></div><a class="d-block" href="detail.html"><img class="img-fluid w-100" src="{{ asset('img/'.$product->i_path)}}" alt="..."></a>
                        <div class="product-overlay">
                          <ul class="mb-0 list-inline" id="cart">
                            
                            <input type="text" hidden value="{{$product->id}}">
                            <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-outline-dark" href="#"><i class="far fa-heart"></i></a></li>
                            <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-dark" >Add to cart</a></li>
