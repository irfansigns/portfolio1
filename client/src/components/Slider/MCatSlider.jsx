    ...
    return (
        <>
          ...
          <div className="row">
            ...
            <div className="col-md-4 mb-4 mb-md-0"><Link to={'/shop/'+1} className="category-item" href="shop.html"><Cat1Slider speed="6200" code="1" cat="1" /><strong className="category-item-title">Jewellery</strong></Link></div>
